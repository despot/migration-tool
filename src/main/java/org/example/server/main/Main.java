...
import org.example.server.country.CountryServer;
import org.example.server.registration.RegistrationServer;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        } else if (serverName.equals("country")) {
            CountryServer.main(args);
        } else {
    ...
    protected static void usage() {
        ...
        System.out.println("       server-name is 'reg', 'registration', " + " or 'country'");
